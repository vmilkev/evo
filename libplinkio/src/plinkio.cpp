...
{
    //int error = 0;
    pio_status_t error = static_cast<pio_status_t>(0);
...
pio_status_t libplinkio_open_txt_ex_(struct pio_file_t *plink_file, const char *ped_path, const char *map_path, const char *fam_path, const char *bim_path, const char *bed_path, bool is_tmp)
{
