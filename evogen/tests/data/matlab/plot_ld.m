...
% file_ld = ["ld_at_0_chr_0.matrld", "ld_at_10_chr_0.matrld", "ld_at_20_chr_0.matrld", ...
%             "ld_at_30_chr_0.matrld", "ld_at_40_chr_0.matrld", "ld_at_50_chr_0.matrld", ...
%             "ld_at_60_chr_0.matrld", "ld_at_70_chr_0.matrld", "ld_at_80_chr_0.matrld", ...
%             "ld_at_99_chr_0.matrld"];
...
file_ld = ["ld_at_0_chr_0.matrld", "ld_at_100_chr_0.matrld", "ld_at_200_chr_0.matrld", "ld_at_300_chr_0.matrld", "ld_at_400_chr_0.matrld", ...
           "ld_at_500_chr_0.matrld", "ld_at_600_chr_0.matrld", "ld_at_700_chr_0.matrld", "ld_at_800_chr_0.matrld", "ld_at_900_chr_0.matrld", ...
           "ld_at_999_chr_0.matrld"];
...
file_ld2 = ["ld_at_0_chr_0.ld", "ld_at_100_chr_0.ld", "ld_at_200_chr_0.ld", "ld_at_300_chr_0.ld", "ld_at_400_chr_0.ld", ...
           ...
           "ld_at_999_chr_0.ld"];
file_ld1 = ["ld_at_0_chr_0.matrld", "ld_at_10_chr_0.matrld", "ld_at_20_chr_0.matrld", "ld_at_30_chr_0.matrld", "ld_at_40_chr_0.matrld", ...
           "ld_at_50_chr_0.matrld", "ld_at_60_chr_0.matrld", "ld_at_70_chr_0.matrld", "ld_at_80_chr_0.matrld", "ld_at_90_chr_0.matrld", ...
           "ld_at_99_chr_0.matrld"];

% file_ld = ["ld_at_1000_chr_0.matrld","ld_at_2000_chr_0.matrld","ld_at_3000_chr_0.matrld","ld_at_4000_chr_0.matrld","ld_at_5000_chr_0.matrld","ld_at_6000_chr_0.matrld","ld_at_7000_chr_0.matrld","ld_at_8000_chr_0.matrld","ld_at_9999_chr_0.matrld"];
...
% file_ld = ["ld_at_399_chr_0.matrld"];
...
for j = 1:size(file_ld,2)
    ...
    for i = 1:nsnp-1
        ...
        ld_shifted(i,range2) = ld(i,i:nsnp);
    end

    for i = 1:nsnp-1
        mean_ld(1,i) = mean_ld(1,i)/(nsnp-i+1);
        n_nonzero = numel(nonzeros(ld_shifted(:,i)));
        mean_ld2(1,i) = sum(ld_shifted(:,i))/n_nonzero;
    end
    plot(1:nsnp, mean_ld, '*', 'LineWidth',2.0);
    plot(1:nsnp, mean_ld2, 'd', 'LineWidth',2.0);
    %plot(1:nsnp, ld2, 'k-', 'LineWidth',1.0);
    box on;
    grid on;
    axis square;
    ylim([0 1]);
