...
def test_model_4():
	...
	model.append_effect("tests/data/model_4/obs_1000_snp_10000.txt", 0); # eff := 0

	model.append_effect("tests/data/model_4/fixed_1000.dat", 0.0);           # eff := 1
	...
	model.append_corrstruct(iG1, 1, "I", 10000, corr_eff)
