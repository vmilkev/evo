...
PYBIND11_MODULE(evoped, m)
{
    ...
    pybind11::class_< evoped::Gmat<double> >( m, "Gmatd" )
        ...
        .def("impute_genotypes", pybind11::overload_cast<const std::string &, const std::string &, const std::string &, const std::string &>(&evoped::Gmat<double>::impute_genotypes))
    ...
    pybind11::class_< evoped::Gmat<float> >( m, "Gmat" )
        ...
        .def("impute_genotypes", pybind11::overload_cast<const std::string &, const std::string &, const std::string &, const std::string &>(&evoped::Gmat<float>::impute_genotypes))
